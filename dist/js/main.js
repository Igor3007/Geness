...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function () {
  ...
  function initInputMask() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("input[type=tel]").inputmask({
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('change', '[for=attach-file] > input', function () {
    ...
    sendFiles(files, function (data) {
      elem.parents('.form__subitem').find('.upload-files').append('<li>' + data.name + '</li>');
    });
  });
  /* input-attach */
...
/* harmony import */ var _import_TweenMax_min__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./import/TweenMax.min */ "./src/js/import/TweenMax.min.js");
/* harmony import */ var _import_TweenMax_min__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_import_TweenMax_min__WEBPACK_IMPORTED_MODULE_6__);
...
jquery__WEBPACK_IMPORTED_MODULE_7___default()(document).ready(function () {
  ...
  var $smallBall = document.querySelector('.about-mouse-circle'); //const $hoverables = document.querySelectorAll('.hoverable');
  // Listeners

  var container = document.querySelector('.about');
  container.addEventListener('mousemove', onMouseMove); // for (let i = 0; i < $hoverables.length; i++) {
  ...
  function changeImage(image) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_7___default()('.main-slider__bg').attr({
  ...
  var about = new swiper__WEBPACK_IMPORTED_MODULE_3__["default"]('.about__wrp .swiper-container', {
    ...
    on: {
      slideChange: function slideChange(data) {
        if (jquery__WEBPACK_IMPORTED_MODULE_7___default()(window).width() > 760) {
          jquery__WEBPACK_IMPORTED_MODULE_7___default()('html,body').stop().animate({
            scrollTop: jquery__WEBPACK_IMPORTED_MODULE_7___default()('.about').offset().top + 40
          }, 300); //alert('ee')
        }
      },
      progress: function progress(data, _progress) {
        console.log(_progress);
        var scrollFadeOut = jquery__WEBPACK_IMPORTED_MODULE_7___default()('.scroll-fade-out');
        var scrollFadeIn = jquery__WEBPACK_IMPORTED_MODULE_7___default()('.scroll-fade-in');
        console.log(_progress);
        var fadeInc = 0.3;
        fadeInc = fadeInc + _progress * 2;
        if (fadeInc > 1) fadeInc = 1;
        if (fadeInc < 0) fadeInc = 0;
        var fadeDec = 1;
        fadeDec = fadeDec - _progress * 3;
        if (fadeDec > 1) fadeDec = 1;
        if (fadeDec < 0) fadeDec = 0;
        var scale = 0.65;
        scale = scale + _progress;
        if (scale > 1) scale = 1;
        var scaleDec = 1;
        scaleDec = scaleDec - _progress;
        if (scaleDec > 1) scaleDec = 1;
        if (scaleDec < 0.6) scaleDec = 0.6;

        if (fadeInc > 0.97) {
          jquery__WEBPACK_IMPORTED_MODULE_7___default()('.scroll-slide-left').addClass('open');
        } else {
          jquery__WEBPACK_IMPORTED_MODULE_7___default()('.scroll-slide-left').removeClass('open');
        }
        ...
        jquery__WEBPACK_IMPORTED_MODULE_7___default()('.about-slide').each(function (index, item) {
          if (index != 0) {
            jquery__WEBPACK_IMPORTED_MODULE_7___default()(this).css({
              'transform': 'scale(' + scale + ')'
            });
          } else {// $(this).find('.about-slide__right').css({
            //   'transform': 'scale('+scale+')'
            // })
          }
        });
...
jquery__WEBPACK_IMPORTED_MODULE_7___default()('.burger').on('click', function (event) {
  jquery__WEBPACK_IMPORTED_MODULE_7___default()('body').toggleClass('hidden');
  jquery__WEBPACK_IMPORTED_MODULE_7___default()(this).toggleClass('open');
  jquery__WEBPACK_IMPORTED_MODULE_7___default()('.header__nav').toggleClass('open');
  var info = jquery__WEBPACK_IMPORTED_MODULE_7___default()('.header__info').clone();
  var signup = jquery__WEBPACK_IMPORTED_MODULE_7___default()('.header__signup').clone();

  if (!jquery__WEBPACK_IMPORTED_MODULE_7___default()('.header__nav > nav').find('div').is('.header__info')) {
    jquery__WEBPACK_IMPORTED_MODULE_7___default()('.header__nav > nav').append(info);
    jquery__WEBPACK_IMPORTED_MODULE_7___default()('.header__nav > nav').append(signup);
  }
});

function initInputMask() {
  jquery__WEBPACK_IMPORTED_MODULE_7___default()("input[type=tel]").inputmask({
    mask: '+7(999) 999-99-99',
    showMaskOnHover: false,
    getemptymask: true,
...
jquery__WEBPACK_IMPORTED_MODULE_7___default()(document).on('click', '[data-modal="callback"]', function (event) {
  var elem = jquery__WEBPACK_IMPORTED_MODULE_7___default()(this);
  jquery__WEBPACK_IMPORTED_MODULE_7___default.a.fancybox.open({
    src: elem.data('src'),
    type: 'ajax',
    opts: {
...
jquery__WEBPACK_IMPORTED_MODULE_7___default()(document).on('click', '[data-modal="phone"]', function (event) {
  var elem = jquery__WEBPACK_IMPORTED_MODULE_7___default()(this);
  jquery__WEBPACK_IMPORTED_MODULE_7___default.a.fancybox.open({
